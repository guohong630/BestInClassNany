...
class wpv_subpages extends WP_Widget {
	...
	public function wpv_subpages() {
		$widget_ops = array(
			'classname' => 'wpv_subpages',
			'description' => __('Displays a list of SubPages', 'davidandgoliath')
		);
		$this->WP_Widget('wpv_subpages', __('Vamtam - List subpages', 'davidandgoliath') , $widget_ops);
	}
