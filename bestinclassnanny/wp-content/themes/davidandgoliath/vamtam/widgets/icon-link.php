...
class wpv_icon_link extends WP_Widget {
	...
	public function wpv_icon_link() {
		$widget_ops = array(
			...
			'description' => __('Displays a list of links preceded by an icon', 'davidandgoliath')
		);
		$this->WP_Widget('icon-link', __('Vamtam - Links with icons', 'davidandgoliath') , $widget_ops);
	}
