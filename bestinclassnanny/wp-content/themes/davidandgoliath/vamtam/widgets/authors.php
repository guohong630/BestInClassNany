...
class wpv_authors extends WP_Widget {
	...
	public function wpv_authors() {
		$widget_opts = array(
			...
			'description' => __('List of authors and their descriptions', 'davidandgoliath')
			);
		$this->WP_Widget('wpv_authors', __('Vamtam - Authors', 'davidandgoliath'), $widget_opts);
	}
	
	public function widget($args, $instance) {
		extract($args);
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Authors', 'davidandgoliath') : $instance['title'], $instance, $this->id_base);
