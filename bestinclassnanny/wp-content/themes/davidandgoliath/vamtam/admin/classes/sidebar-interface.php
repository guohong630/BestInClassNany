...
?>
		<script type='text/html' id='wpv-add-sidebar-ui'>
			<form class='wpv-add-sidebar-ui' method='POST'>
				<h3><?php _e('Vamtam Widget Areas', 'davidandgoliath') ?></h3>
				<input type='text' value='' placeholder='<?php _e('New Widget Area Name', 'davidandgoliath') ?>' name='new-sidebar-id' />
				<input type='submit' value='<?php _e('Add Widget Area', 'davidandgoliath') ?>' class="button-primary" />
