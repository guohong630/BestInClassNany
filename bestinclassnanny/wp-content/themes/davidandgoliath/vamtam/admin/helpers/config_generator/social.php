...
$contexts = array(
	'post' => __('Post', 'davidandgoliath'),
	'page' => __('Page', 'davidandgoliath'),
	'portfolio' => __('Portfolio', 'davidandgoliath'),
	'product' => __('Product', 'davidandgoliath'),
	'lightbox' => __('Lightbox', 'davidandgoliath'),
);
