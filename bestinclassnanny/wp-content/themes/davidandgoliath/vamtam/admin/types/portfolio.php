...
function edit_portfolio_columns($portfolio_columns) {
	$columns = array(
		...
		"title" => _x('Title', 'column name', 'davidandgoliath' ),
		"portfolio_category" => __('Categories', 'davidandgoliath' ),
		"author" => __('Author', 'davidandgoliath' ),
		"date" => __('Date', 'davidandgoliath' ),
		"thumbnail" => __('Thumbnail', 'davidandgoliath' )
	);
