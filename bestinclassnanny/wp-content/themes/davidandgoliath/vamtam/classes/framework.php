...
class WpvFramework {
	...
	public static function getVersion() {
		...
		self::$cache['version'] = wp_get_theme()->get('Version');
	...
	public function theme_supports() {
		...
		if(function_exists('register_nav_menus')) {
			register_nav_menus(array(
				'menu-header' => __('Menu Header', 'davidandgoliath'),
				'menu-top' => __('Menu Top', 'davidandgoliath'),
			));
		}
		...
		add_image_size('posts-widget-thumb', 400, 250, true);
		...
		$single_sizes = array('single-portfolio', 'single-post', 'post-loop');
	...
	private function load_languages() {
		load_theme_textdomain('davidandgoliath', THEME_DIR . 'languages');
	}
	...
	private function load_types() {
		...
		register_post_type('portfolio', array(
			'labels' => array(
				'name' => _x('Portfolios', 'post type general name', 'davidandgoliath' ),
				'singular_name' => _x('Portfolio', 'post type singular name', 'davidandgoliath' ),
				'add_new' => _x('Add New', 'portfolio', 'davidandgoliath' ),
				'add_new_item' => __('Add New Portfolio', 'davidandgoliath' ),
				'edit_item' => __('Edit Portfolio', 'davidandgoliath' ),
				'new_item' => __('New Portfolio', 'davidandgoliath' ),
				'view_item' => __('View Portfolio', 'davidandgoliath' ),
				'search_items' => __('Search Portfolios', 'davidandgoliath' ),
				'not_found' =>  __('No portfolios found', 'davidandgoliath' ),
				'not_found_in_trash' => __('No portfolios found in Trash', 'davidandgoliath' ),
				'parent_item_colon' => '',
			),
			'singular_label' => __('portfolio', 'davidandgoliath' ),
			'public' => true,
		...
		register_taxonomy('portfolio_category','portfolio',array(
			'hierarchical' => true,
			'labels' => array(
				'name' => _x( 'Categories', 'taxonomy general name', 'davidandgoliath' ),
				'singular_name' => _x( 'Portfolio Category', 'taxonomy singular name', 'davidandgoliath' ),
				'search_items' =>  __( 'Search Categories', 'davidandgoliath' ),
				'popular_items' => __( 'Popular Categories', 'davidandgoliath' ),
				'all_items' => __( 'All Categories', 'davidandgoliath' ),
				'parent_item' => null,
				'parent_item_colon' => null,
				'edit_item' => __( 'Edit Portfolio Category', 'davidandgoliath' ),
				'update_item' => __( 'Update Portfolio Category', 'davidandgoliath' ),
				'add_new_item' => __( 'Add New Portfolio Category', 'davidandgoliath' ),
				'new_item_name' => __( 'New Portfolio Category Name', 'davidandgoliath' ),
				'separate_items_with_commas' => __( 'Separate Portfolio category with commas', 'davidandgoliath' ),
				'add_or_remove_items' => __( 'Add or remove portfolio category', 'davidandgoliath' ),
				'choose_from_most_used' => __( 'Choose from the most used portfolio category', 'davidandgoliath' )
			),
			'show_ui' => true,
			'query_var' => true,
			'rewrite' => false,
		...
		register_post_type('testimonials', array(
			'labels' => array(
				'name' => _x('Testimonials', 'post type general name', 'davidandgoliath' ),
				'singular_name' => _x('Testimonial', 'post type singular name', 'davidandgoliath' ),
				'add_new' => _x('Add New', 'testimonials', 'davidandgoliath' ),
				'add_new_item' => __('Add New Testimonial', 'davidandgoliath' ),
				'edit_item' => __('Edit Testimonial', 'davidandgoliath' ),
				'new_item' => __('New Testimonial', 'davidandgoliath' ),
				'view_item' => __('View Testimonial', 'davidandgoliath' ),
				'search_items' => __('Search Testimonials', 'davidandgoliath' ),
				'not_found' =>  __('No testimonials found', 'davidandgoliath' ),
				'not_found_in_trash' => __('No testimonials found in Trash', 'davidandgoliath' ),
				'parent_item_colon' => '',
			),
			'singular_label' => __('testimonial', 'davidandgoliath' ),
			'public' => true,
		...
		register_taxonomy('testimonials_category','testimonials',array(
			'hierarchical' => true,
			'labels' => array(
				'name' => _x( 'Testimonials Category', 'taxonomy general name', 'davidandgoliath' ),
				'singular_name' => _x( 'Testimonial Category', 'taxonomy singular name', 'davidandgoliath' ),
				'search_items' =>  __( 'Search Categories', 'davidandgoliath' ),
				'popular_items' => __( 'Popular Categories', 'davidandgoliath' ),
				'all_items' => __( 'All Categories', 'davidandgoliath' ),
				'parent_item' => null,
				'parent_item_colon' => null,
				'edit_item' => __( 'Edit Testimonials Category', 'davidandgoliath' ),
				'update_item' => __( 'Update Testimonials Category', 'davidandgoliath' ),
				'add_new_item' => __( 'Add New Testimonials Category', 'davidandgoliath' ),
				'new_item_name' => __( 'New Testimonials Category Name', 'davidandgoliath' ),
				'separate_items_with_commas' => __( 'Separate Testimonials category with commas', 'davidandgoliath' ),
				'add_or_remove_items' => __( 'Add or remove testimonials category', 'davidandgoliath' ),
				'choose_from_most_used' => __( 'Choose from the most used testimonials category', 'davidandgoliath' )
			),
			'show_ui' => true,
			'query_var' => false,
			'rewrite' => false,
	...
	private function load_shortcodes() {
		...
		include WPV_SHORTCODES . 'map-trigger.php';
	...
	public function setup_adminbar() {
		...
		$wp_admin_bar->add_menu( array(
			'parent' => false,
			'id' => 'wpv-settings',
			'title' => __('Vamtam', 'davidandgoliath'),
			'href' => admin_url( 'admin.php?page=wpv_general'),
			'meta' => false
		));

		$adv_name = __('Theme options', 'davidandgoliath');

		$pages = array(
			'general' => __('General Settings', 'davidandgoliath'),
			'layout' => __('Layout', 'davidandgoliath'),
			'styles' => __('Styles', 'davidandgoliath'),
			'import' => __('Quick Import', 'davidandgoliath'),
			'help' => __('Help', 'davidandgoliath'),
		);
