...
<div class="row portfolio-content">
	...
	<?php if($has_right_column): ?>
		<div class="grid-1-5 last">
			...
			<div class="cell">
				<div  class="meta-title"><?php _e('Date', 'davidandgoliath') ?></div>
				<p class="meta"><?php the_date() ?></p>
			</div>
				
			<?php if(!empty($client)): ?>
				<div class="cell">	
					<div  class="meta-title"><?php _e('Client', 'davidandgoliath') ?></div>
			...
			<?php if(!empty($terms_name)): ?>
				<div class="cell">
					<div  class="meta-title"><?php _e('Category', 'davidandgoliath') ?></div>
