...
<p>
	<label for="<?php echo $this->get_field_id('address'); ?>"><?php _e('Address:', 'davidandgoliath'); ?></label>
	<input class="widefat" id="<?php echo $this->get_field_id('address'); ?>" name="<?php echo $this->get_field_name('address'); ?>" type="text" value="<?php echo $address; ?>" />
	<small><?php _e('Choose either an address or latitute and logtitude', 'davidandgoliath')?></small>
</p>
		
<p>
	<label for="<?php echo $this->get_field_id('latitude'); ?>"><?php _e('Latitude:', 'davidandgoliath'); ?></label>
...
<p>
	<label for="<?php echo $this->get_field_id('longitude'); ?>"><?php _e('Longitude:', 'davidandgoliath'); ?></label>
...
<p>
	<label for="<?php echo $this->get_field_id('zoom'); ?>"><?php _e('Zoom level:', 'davidandgoliath'); ?></label>
...
<p>
	<label for="<?php echo $this->get_field_id('html'); ?>"><?php _e('Content for the marker:', 'davidandgoliath'); ?></label>
...
<p>
	...
	<label for="<?php echo $this->get_field_id('popup'); ?>"><?php _e('Auto popup the info?', 'davidandgoliath'); ?></label>
</p>
		
<p>
	<label for="<?php echo $this->get_field_id('height'); ?>"><?php _e('Height:', 'davidandgoliath'); ?></label>
