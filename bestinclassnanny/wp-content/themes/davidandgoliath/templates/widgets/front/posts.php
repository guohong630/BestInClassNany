...
$title_tag = apply_filters('wpv_multiwidget_item_title_tag', 'h5');
					...
					<div class="clearfix">
						<div class="post_extra_info nothumb">
							<<?php echo $title_tag?> class="title">
								<a href="<?php echo $c->comment_author_url ?>" rel="nofollow"><?php echo $c->comment_author ?></a> <?php _e('on', 'davidandgoliath') ?> <a href="<?php echo get_permalink($post->ID) ?>"><?php echo $post->post_title ?></a>
							</<?php echo $title_tag?>>
					...
					<li>
						<div class="clearfix">
							...
							<div class="post_extra_info <?php if($disable_thumbnail || !$has_media) echo 'nothumb'?>">
								...
								<<?php echo $meta_tag?> class="comments"><?php comments_popup_link(__('0 <span class="comment-word">Comments</span>', 'davidandgoliath'), __('1 <span class="comment-word">Comment</span>', 'davidandgoliath'), __('% <span class="comment-word">Comments</span>', 'davidandgoliath')); ?></<?php echo $meta_tag?>>
							</div>
						</div>
