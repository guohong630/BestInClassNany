...
<section class="portfolios row <?php if(!empty($sortable)) echo $engine ?> <?php echo $scrollable ? 'scroll-x' : 'normal' ?> title-<?php echo $title ?> <?php echo $desc ? 'has-description' : 'no-description' ?> <?php if(!empty($class)) echo $class; ?>">
	<?php
