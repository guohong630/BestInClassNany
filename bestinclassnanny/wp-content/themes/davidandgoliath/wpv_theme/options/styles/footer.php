...
array(
	'name' => __('Widget Areas Background', 'davidandgoliath'),
...
array(
	'name' => __('Sub-footer Background', 'davidandgoliath'),
	'desc' => __('If you want to use an image as a background, enabling the cover button will resize and crop the image so that it will always fit the browser window on any resolution.', 'davidandgoliath'),
...
array(
	'name' => __('Widget Areas Text', 'davidandgoliath'),
	'desc' => __('This is the general font used for the footer widgets.', 'davidandgoliath'),
...
array(
	'name' => __('Widget Areas Titles', 'davidandgoliath'),
	'desc' => __('Please note that this option will override the general headings style set in the General Typography" tab.', 'davidandgoliath'),
...
array(
	'name' => __('Sub-footer', 'davidandgoliath'),
	'desc' => __('You can place your text/HTML in the General Settings option page.', 'davidandgoliath'),
	'id' => 'sub-footer',
	'type' => 'font',
	'min' => 10,
	'max' => 32,
