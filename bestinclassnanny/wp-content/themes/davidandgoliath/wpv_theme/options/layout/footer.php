...
array(
	'name' => __('Footer', 'davidandgoliath'),
	'type' => 'start',
),

array(
	'name' => __('Footer Layout', 'davidandgoliath'),
	'desc' => __('You can enable or disable the footer widget areas and choose the desired layout. This will be the default layout for all pages.<br/>
		Please not that the footer map options are located in general settings - footer map tab', 'davidandgoliath'),
	'type' => 'info',
),

array(
	'name' => __('Enable Footer Widget Areas', 'davidandgoliath'),
	'desc' => __('This option only enables the area. You can set the layout, using the two options below.  In appearance - widgets, you can populate the area with widgets.', 'davidandgoliath'),
	'id' => 'has-footer-sidebars',
	'type' => 'toggle',
),

array(
	'name' => __('Footer Widget Area Pre-defined Layouts', 'davidandgoliath'),
	'desc' => __('The widget areas bellow are placed between the body and the sub-footer.  You can either choose one of the predefined layouts or configure your own in the "Advanced" section bellow.', 'davidandgoliath'),
	'type' => 'autofill',
	'class' => 'no-box',
	'option_sets' => array(
		array(
...
array(
	'name' => __('Footer Widget Areas Advanced Layout Builder', 'davidandgoliath'),
...
array(
	'name' => __('Text Area in Footer', 'davidandgoliath'),
	'desc' => __('You can place text/HTML or any shortcode in this field. The text will appear in the  footer of your website.', 'davidandgoliath'),
	'id' => 'credits',
	'type' => 'textarea',
	'static' => true,
),
