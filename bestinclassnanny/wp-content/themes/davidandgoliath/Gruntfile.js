module.exports = function(grunt) {
	...
	grunt.registerTask('build-plugins', ['compress:push-menu', 'compress:layerslider', 'compress:love-it']);
	...
	grunt.registerTask('package', [
		...
		'copy:theme',
		'prepare-skins', 'scp-download-samples', 'download-images', 'download-content-xml', 'download-sidebars-options-layerslider',
		'clean:post-copy',
