...
class WPV_Editor {
	...
	public function admin_init() {
		...
		foreach ( $post_types as $type ) {
			add_meta_box( 'wpv_visual_editor', __( 'Visual Editor', 'davidandgoliath' ), array( &$this, 'editor' ), $type, 'advanced', 'low' );
		}
	...
	private function enqueues() {
		...
		wp_localize_script( 'wpv-editor', 'WPVED_LANG', array(
				'empty_notice' => __( 'Please drag  any element you want here.', 'davidandgoliath' ),
			) );
	}
							...
							<?php if ( isset( $wpv_sc[$slug]['desc'] ) ): ?>
								<div class="description">
									...
									<div>
										...
										<footer><a href="<?php echo esc_attr(admin_url( 'admin.php?page=wpv_help' )) ?>" title="<?php _e( 'Read more in our documentation', 'davidandgoliath' ) ?>"><?php _e( 'Read more in our documentation', 'davidandgoliath' ) ?></a></footer>
									</div>
								</div>
							<?php endif ?>
						</li>
