<?php
return array(
	'name' => __('LayerSlider', 'davidandgoliath') ,
	...
	If you need to activate the slider in the Header, then you will need the option - "Page Slider" found below the editor. ' , 'davidandgoliath'),
	'icon' => array(
	...
	'options' => array(
		array(
			'name' => __('Slider', 'davidandgoliath') ,
			'id' => 'id',
			'default' => '',
